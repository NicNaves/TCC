package br.com.graspfs.rcl.cs.service;

import br.com.graspfs.rcl.cs.dto.DataSolution;
import br.com.graspfs.rcl.cs.dto.FeatureAvaliada;
import br.com.graspfs.rcl.cs.machinelearning.MachineLearning;
import br.com.graspfs.rcl.cs.util.MachineLearningUtils;
...
import static br.com.graspfs.rcl.cs.util.SelectionFeaturesUtils.quickSort;


public class ChiSquaredService {
    private final Logger logg = LoggerFactory.getLogger(ChiSquaredService.class);
    ...
    public void rankFeatures(DataSolution solution, Instances treino, int pontoCorte) throws Exception {
        ...
        try{
            ...
            for (int i = 0; i < treino.numAttributes(); i++) {
                double peso = SelectionFeaturesUtils.calcularaChiSuared(treino, i);
    ...
    public DataSolution doChiSquared() throws Exception {
